        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-description">
              A payment platform built by africans for africans in the diaspora facing 
              the challenges of sending money to their loved ones or paying bills back at home.
            </p>
            ...
            <div className="footer-social">
              ...
              <a href="https://linkedin.com/company/sabo" className="social-icon" aria-label="LinkedIn">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://facebook.com/sabo" className="social-icon" aria-label="Facebook">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
