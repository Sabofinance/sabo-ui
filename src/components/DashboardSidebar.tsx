    ...
    <aside className="dashboard-sidebar">
      ...
      <nav className="sidebar-nav" aria-label="Main navigation">
        <ul className="nav-list">
          ...
          <li className="nav-item">
            <NavLink to="/dashboard/active-sabits" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          <li className="nav-item">
            <NavLink to="/dashboard/my-sabits" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
          ...
          <li className="nav-item">
            <NavLink to="/dashboard/chat" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
