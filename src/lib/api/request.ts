...
export const apiRequest = {
  ...
  async post<T = unknown>(url: string, payload?: Payload): Promise<ApiEnvelope<T>> {
    try {
  ...
  async patch<T = unknown>(url: string, payload?: Payload): Promise<ApiEnvelope<T>> {
    try {
  ...
  async put<T = unknown>(url: string, payload?: Payload): Promise<ApiEnvelope<T>> {
    try {
